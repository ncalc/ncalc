...
* [Fix using math operations with double/decimal parameters passed as string in non-English environments](https://github.com/ncalc/ncalc/pull/213) by [Andrey Bykiev](https://github.com/Bykiev)
